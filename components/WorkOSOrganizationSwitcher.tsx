...
export const WorkOSOrganizationSwitcher = () => {
    ...
    if (isLoading) return (
        <div className="p-12 flex flex-col items-center justify-center gap-4 text-stone-500 min-h-[300px]">
            ...
            <span className="text-sm font-medium tracking-wide">Loading Organizations...</span>
        </div>
    );
    ...
    if (!user) return (
        <div className="p-12 flex flex-col items-center justify-center gap-4 text-stone-500 min-h-[300px] border border-stone-200 rounded-2xl bg-stone-50/50">
            ...
            <p className="text-sm font-medium">Please sign in to switch organizations.</p>
        </div>
    );
    ...
    return (
        <div className="bg-white rounded-2xl border border-stone-200 shadow-sm overflow-hidden p-6 md:p-10 min-h-[500px]">
            <div className="mb-8">
                <h2 className="font-serif text-2xl font-bold text-stone-900">Organizations</h2>
                <p className="text-stone-500 text-sm mt-1">Switch between different workspaces and companies you belong to.</p>
            </div>
